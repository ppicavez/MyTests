...
#        recherche des distance maxi ds chaque direction des pac
        ...
        for i_dir in range(4) :
            print(" Direction "+str(i_dir), file=sys.stderr)
            l = adjacents_segment_length[n_pac][i_dir]
            print(" l segment "+str(l), file=sys.stderr)
            if l > 0 :
                i_pellet = 0
                while i_pellet < nb_small_pellet :
                    ...
                    if pacs_x[n_pac] == liste_x[index_pellet] or pacs_y[n_pac] == liste_y[index_pellet] :
                        ...
                        if i_dir == 0  and  pacs_x[n_pac] == liste_x[index_pellet]: #Haut
                        ...
                        elif i_dir == 1  and  not found and pacs_y[n_pac] == liste_y[index_pellet]: #Haut
                            ...
                            while not found and i_segment < l :
                                ...
                                if x == liste_x[index_pellet] :
                                    ...
                                    i_segment = i_segment + 1
                        elif i_dir == 2  and  not found and pacs_x[n_pac] == liste_x[index_pellet]: #Haut
