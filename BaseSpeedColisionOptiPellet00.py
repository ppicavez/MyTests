...
#Création liste des pellets à 10 points
    ...
    for i_pellet in range(nb_small_pellet) :
        ...
        while found == -1 and i_pac < nb_mine_pacs :
            ...
            if adjacents_squares[0] == liste_1[i_pellet] :
                found = 0 #Haut
                adjs[0].append(liste_1[i_pellet])
            elif adjacents_squares[2] == liste_1[i_pellet]:
                found = 1 # Droite
                adjs[1].append(liste_1[i_pellet])
            elif adjacents_squares[4] == liste_1[i_pellet]:
                found = 3 # Bas
                adjs[2].append(liste_1[i_pellet])
            elif adjacents_squares[6] == liste_1[i_pellet]:
                found = 4  # Gauche 
