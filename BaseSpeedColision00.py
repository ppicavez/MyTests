...
for n_square in range(nb_squares):
    adjacentes = find_adjacentes(squares_x[n_square],squares_y[n_square],
        squares_x,squares_y )
    adjacents_squares.append(adjacentes)

    #for j in range(len(adjacentes)) :
    #    print("Adj de  "+str(n_square)+ " coord = "+str(squares_x[n_square])+ ' '+
    #        "-"+str(squares_y[n_square])+" =  "+
    #        str(adjacentes[j]), file=sys.stderr)
    #    if adjacentes[j] >= 0 :
    #       print("coord = "+str(squares_x[adjacentes[j]])+ ' '+
...
#Analyse des colisions entre mes pacs
    ...
    #Ce n'est pas le premier tour    m
        ...
        if nb_blocked > 1:
            ...
            adj_1 = adjacents_squares[blocked_1]
            adj_2 = adjacents_squares[blocked_2]
