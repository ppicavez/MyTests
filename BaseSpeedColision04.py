...
#Analyse des colisions entre mes pacs
    ...
    #Ce n'est pas le premier tour    m
        ...
        if nb_blocked > 1:
            ...
            print("afectation DEBLOC No" +str(blocked_1) + " " + position +" " , file=sys.stderr)
            ...
            if found :
                ...
                print("afectation DEBLOC No" +str(blocked_2) + " " + position +" " , file=sys.stderr)
