...
for n_square in range(nb_squares):
    ...
    for i_dir in range(4):
        ...
        adjacents_segment_length.append(l_dir)
...
while True:
    ...
    for i in range(visible_pac_count):
        ...
        #print("Restants :  "+ str(nb_squares_not_explored)+"  = "+str(len(squares_not_explored)), file=sys.stderr)
        if mine :
...
#Analyse des colisions entre mes pacs
    ...
    blocked = []
    print(" Passage colision", file=sys.stderr)
    for n_pac in range(nb_mine_pacs) :
